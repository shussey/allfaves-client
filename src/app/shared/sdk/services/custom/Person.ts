...
export class PersonApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public create(data: any = {}): Observable<Person> {
   ...
   * </em>
   */
  public upsert(data: any = {}): Observable<Person> {
   ...
   * </em>
   */
  public upsertWithWhere(where: any = {}, data: any = {}): Observable<Person> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public findById(id: any, filter: LoopBackFilter = {}): Observable<Person> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/people/:id";
    let _routeParams: any = {
   ...
   * </em>
   */
  public find(filter: LoopBackFilter = {}): Observable<Array<Person>> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/people";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public findOne(filter: LoopBackFilter = {}): Observable<Person> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/people/findOne";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public createMany(data: Array<any> = []): Observable<Array<Person>> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/people";
    let _routeParams: any = {};
